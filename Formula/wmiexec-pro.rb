class WmiexecPro < Formula
  ...
  url "https://github.com/XiaoliChan/wmiexec-Pro/archive/88219015ed7e19d5fb41ee702f93115718463081.tar.gz"
  version "0.4.1,1,8821901"
  sha256 "07c21b9a60abe6383be0aadb4d217932ddd46170e5611b00fa6c0265bc947c92"
  ...
  test do
    output = shell_output("#{bin}/wmiexec-pro.py -h")
    assert_match "usage: wmiexec-pro.py", output
  end
end

__END__
diff --git a/requirements.txt b/requirements.txt
index 7f5ea9b..ec26f1a 100644
--- a/requirements.txt
+++ b/requirements.txt
@@ -1,2 +1,3 @@
 impacket
